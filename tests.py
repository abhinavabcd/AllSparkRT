...
def test1():
    ...
    auth_key_client1 = cookies.create_signed_value(config.SERVER_SECRET , config.SERVER_AUTH_KEY_STRING, json.dumps({'node_id':client_node_id1}))
    
    
    
    auth_key_client2 = cookies.create_signed_value(config.SERVER_SECRET , config.SERVER_AUTH_KEY_STRING ,json.dumps({'node_id':client_node_id2}))
...
def test2():
    ...
    auth_key_client1 = cookies.create_signed_value(config.SERVER_SECRET , "auth", json.dumps({'node_id':client_node_id1}))
    
    auth_key_client2 = cookies.create_signed_value(config.SERVER_SECRET , "auth",json.dumps({'node_id':client_node_id2}))
